...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED_T2star_philips571AP_ZOOM_2pulse1
global VCtl
global VVar
CV1=1;
CV10=((VCtl.EPI_ETL)*10/32)*VCtl.EPI_ESP;
CV11=5e-3;
CV12=3.54e-3;
CV13=19e-3;
CV14=0e-3;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+CV10+CV11*1+CV14+1e-3;
...
p=[];
%--------------------
p.Area=-5/16*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
...
p=[];
%--------------------
p.Area=-6/16*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
