...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED_T2STAR2_108
global VCtl
global VVar
CV1=1;
CV10=17.37e-3;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+2.304e-3+CV10;
p.tStart=CV3-2.304e-3+CV10;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+2.304e-3+CV10+CV11;
p.tStart=CV3-2.304e-3+CV10+CV11;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+2.304e-3+CV10+CV11*2;
p.tStart=CV3-2.304e-3+CV10+CV11*2;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+1.664e-3;
p.tStart=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14-1.664e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p=[];
%--------------------
p.Area=-19/128*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV13;
if strcmp(p.Switch,'on')
...
p=[];
%--------------------
p.Area=-VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14-4e-3;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+CV6+(VCtl.EPI_ETL/2)*VCtl.EPI_ESP;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14-2.9e-3;
p.tStart=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14-3.5e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+2.5e-3;
p.tStart=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+1.9e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14-3e-3;
p.tStart=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14-3.5e-3;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+2.5e-3;
p.tStart=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+2e-3;
if strcmp(p.Switch,'on')
...
p=[];
%--------------------
p.Area=1*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes='dephase';
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tEnd=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+0.7e-3;
p.tStart=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+0.2e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=CV3+CV10+CV11*2+CV13;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=CV3+CV10+CV11*2+CV12+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV14+CV6+(VCtl.EPI_ETL/2)*VCtl.EPI_ESP;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tStart=CV3+VCtl.delta_TE+17.35e-3*2+12.185e-3-2e-3;
if strcmp(p.Switch,'on')
