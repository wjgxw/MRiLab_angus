...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLEDSM
global VCtl
global VVar
CV1=75e-3;
CV10=0;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV9+VCtl.delta_TE+1e-3;
p.tStart=CV9+VCtl.delta_TE-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.TE/2+VCtl.delta_TE/4+1e-3;
p.tStart=VCtl.TE/2+VCtl.delta_TE/4-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.T1Exc+1e-3;
p.tStart=VCtl.T1Exc-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=(VCtl.T1TE+VCtl.T1Exc)/2+1e-3;
p.tStart=(VCtl.T1TE+VCtl.T1Exc)/2-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
