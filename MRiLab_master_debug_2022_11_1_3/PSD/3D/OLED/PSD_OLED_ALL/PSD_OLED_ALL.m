...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED_ALL
global VCtl
global VVar
CV1=1;
CV10=(VCtl.EPI_ETL/4-1)*VCtl.EPI_ESP;
CV11=(VCtl.EPI_ETL/4)*VCtl.EPI_ESP;
CV12=3.54e-3;
CV13=CV12+(VCtl.EPI_ETL/2)*VCtl.EPI_ESP;
CV14=CV13-1.5*CV11;
CV2=80e-3;
CV3=15e-3;
CV4=200e-3;
CV5=0.79e-3;
CV6=500e-3+CV10+CV11*2+CV14+CV12+CV5+VCtl.EPI_ETL*2*VCtl.EPI_ESP;
CV7=0;
CV8=0;
CV9=0;
LLOLED_Slice=2;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+1e-3+CV10;
p.tStart=CV3-1e-3+CV10;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+1e-3+CV10+CV11;
p.tStart=CV3-1e-3+CV10+CV11;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+1e-3+CV10+CV11*2;
p.tStart=CV3-1e-3+CV10+CV11*2;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+CV10+CV11*2+CV14+0.8e-3;
p.tStart=CV3+CV10+CV11*2+CV14-0.8e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3-5e-3+0.8e-3;
p.tStart=CV3-5e-3-0.8e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
[rfAmp7,rfPhase7,rfFreq7,rfCoil7,rfTime7]=rfSLR(p);
if strcmp(VCtl.MultiTransmit,'off')
...
[rfAmp8,rfPhase8,rfFreq8,rfCoil8,rfTime8]=rfSLR(p);
if strcmp(VCtl.MultiTransmit,'off')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.t2End=CV3-5e-3+0.8e-3;
p.t2Start=CV3-5e-3-0.8e-3;
p.tRamp=40e-6;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.t2End=CV3+1e-3+CV10;
p.t2Start=CV3-1e-3+CV10;
p.tRamp=40e-6;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.t2End=CV3+1e-3+CV10+CV11;
p.t2Start=CV3-1e-3+CV10+CV11;
p.tRamp=40e-6;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.t2End=CV3+1e-3+CV10+CV11*2;
p.t2Start=CV3-1e-3+CV10+CV11*2;
p.tRamp=40e-6;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.t2End=CV3+CV10+CV11*2+CV14+0.8e-3;
p.t2Start=CV3+CV10+CV11*2+CV14-0.8e-3;
p.tRamp=40e-6;
if strcmp(p.Switch,'on')
...
p=[];
%--------------------
p.Area=-31/128*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=3;
p.Notes=[];
AttributeOpt={'on','off'};
...
p.Switch=AttributeOpt{1};
p.grady_idx=4;
p.tStart=CV3+CV10+CV11*2+CV14/2;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV10+CV11*2+CV14+CV13;
if strcmp(p.Switch,'on')
...
p=[];
%--------------------
p.Area=-1/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=3;
p.Notes=[];
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tStart=CV3+CV10+CV11*2+CV14+CV13+0.79e-3+(VCtl.EPI_ETL-1)*VCtl.EPI_ESP;
if strcmp(p.Switch,'on')
[GyAmp6,GyTime6]=GyAreaTrapezoid2(p);
GyAmp=[GyAmp GyAmp6];
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV5+(VCtl.EPI_ETL)*VCtl.EPI_ESP;
if strcmp(p.Switch,'on')
[GyAmp7,GyTime7]=GyEPI_nodephase(p);
GyAmp=[GyAmp GyAmp7];
GyTime=[GyTime GyTime7];
end
p=[];
%--------------------
p.Area=-2.1*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=1;
p.Notes='crush1';
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV14-2.9e-3;
p.tStart=CV3+CV10+CV11*2+CV14-3.5e-3;
if strcmp(p.Switch,'on')
[GyAmp8,GyTime8]=GyAreaTrapezoid(p);
GyAmp=[GyAmp GyAmp8];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV14+2.5e-3;
p.tStart=CV3+CV10+CV11*2+CV14+1.9e-3;
if strcmp(p.Switch,'on')
[GyAmp9,GyTime9]=GyAreaTrapezoid(p);
GyAmp=[GyAmp GyAmp9];
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV6;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV6*2;
if strcmp(p.Switch,'on')
[GyAmp11,GyTime11]=GyEPI(p);
GyAmp=[GyAmp GyAmp11];
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV5+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV6*2;
if strcmp(p.Switch,'on')
[GyAmp12,GyTime12]=GyEPI_nodephase(p);
GyAmp=[GyAmp GyAmp12];
GyTime=[GyTime GyTime12];
end
p=[];
%--------------------
p.Area=-2.3*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=1;
p.Notes='crush1';
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3-5e-3-2e-3-0.5e-3;
p.tStart=CV3-5e-3-2e-3-1.1e-3;
if strcmp(p.Switch,'on')
[GyAmp13,GyTime13]=GyAreaTrapezoid(p);
GyAmp=[GyAmp GyAmp13];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3-5e-3+2e-3+1.1e-3;
p.tStart=CV3-5e-3+2e-3+0.5e-3;
if strcmp(p.Switch,'on')
[GyAmp14,GyTime14]=GyAreaTrapezoid(p);
GyAmp=[GyAmp GyAmp14];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV6+CV3+CV10+CV11*2+CV14-2.9e-3;
p.tStart=CV6+CV3+CV10+CV11*2+CV14-3.5e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV6+CV3+CV10+CV11*2+CV14+2.6e-3;
p.tStart=CV6+CV3+CV10+CV11*2+CV14+2e-3;
if strcmp(p.Switch,'on')
...
p=[];
%--------------------
p.Area=-0.7*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=1;
p.Notes='crush1';
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV6*2+CV3+CV10+CV11*2+CV14-2.9e-3;
p.tStart=CV6*2+CV3+CV10+CV11*2+CV14-3.5e-3;
if strcmp(p.Switch,'on')
[GyAmp17,GyTime17]=GyAreaTrapezoid(p);
GyAmp=[GyAmp GyAmp17];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV6*2+CV3+CV10+CV11*2+CV14+2.6e-3;
p.tStart=CV6*2+CV3+CV10+CV11*2+CV14+2e-3;
if strcmp(p.Switch,'on')
[GyAmp18,GyTime18]=GyAreaTrapezoid(p);
GyAmp=[GyAmp GyAmp18];
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV5+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV6*1;
if strcmp(p.Switch,'on')
[GyAmp19,GyTime19]=GyEPI_nodephase(p);
GyAmp=[GyAmp GyAmp19];
GyTime=[GyTime GyTime19];
end
p=[];
%--------------------
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13;
if strcmp(p.Switch,'on')
...
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV5+(VCtl.EPI_ETL)*VCtl.EPI_ESP;
if strcmp(p.Switch,'on')
[GxAmp6,GxTime6]=GxEPI_nodephase(p);
GxAmp=[GxAmp GxAmp6];
GxTime=[GxTime GxTime6];
end
p=[];
%--------------------
p.Area=-1.7*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=1;
p.Notes='crush1';
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV14-3e-3;
p.tStart=CV3+CV10+CV11*2+CV14-3.5e-3;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.tEnd=CV3+CV10+CV11*2+CV14+2.5e-3;
p.tStart=CV3+CV10+CV11*2+CV14+2e-3;
if strcmp(p.Switch,'on')
[GxAmp8,GxTime8]=GxAreaTrapezoid(p);
GxAmp=[GxAmp GxAmp8];
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV5+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV6;
if strcmp(p.Switch,'on')
[GxAmp10,GxTime10]=GxEPI_nodephase(p);
GxAmp=[GxAmp GxAmp10];
...
p.t2Middle=CV3+CV10+CV11*2+CV14+CV13+CV5+(VCtl.EPI_ETL)*VCtl.EPI_ESP+CV6*2;
if strcmp(p.Switch,'on')
[GxAmp12,GxTime12]=GxEPI_nodephase(p);
GxAmp=[GxAmp GxAmp12];
GxTime=[GxTime GxTime12];
end
p=[];
%--------------------
p.Area=-1.9*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=1;
p.Notes='crush1';
AttributeOpt={'on','off'};
...
p.tStart=CV3-5e-3-2e-3-1.1e-3;
if strcmp(p.Switch,'on')
[GxAmp13,GxTime13]=GxAreaTrapezoid(p);
GxAmp=[GxAmp GxAmp13];
...
p.tStart=CV3-5e-3+2e-3+0.5e-3;
if strcmp(p.Switch,'on')
[GxAmp14,GxTime14]=GxAreaTrapezoid(p);
GxAmp=[GxAmp GxAmp14];
GxTime=[GxTime GxTime14];
end
p=[];
%--------------------
p.Area=-1.3*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=CV6;
p.Duplicates=1;
p.Notes='crush1';
AttributeOpt={'on','off'};
...
p.tStart=CV6*2+CV3+CV10+CV11*2+CV14-3.5e-3;
if strcmp(p.Switch,'on')
[GxAmp17,GxTime17]=GxAreaTrapezoid(p);
GxAmp=[GxAmp GxAmp17];
...
p.tStart=CV6*2+CV3+CV10+CV11*2+CV14+2e-3;
if strcmp(p.Switch,'on')
[GxAmp18,GxTime18]=GxAreaTrapezoid(p);
GxAmp=[GxAmp GxAmp18];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=CV3+CV10+CV11*2+CV14+CV13;
if strcmp(p.Switch,'on')
[ADC1,ADCTime1]=ADCEPItrain(p);
ADC=[ADC ADC1];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=CV3+CV10+CV11*2+CV14+CV13+CV5+(VCtl.EPI_ETL)*VCtl.EPI_ESP;
if strcmp(p.Switch,'on')
[ADC2,ADCTime2]=ADCEPItrain(p);
ADC=[ADC ADC2];
...
p=[];
%--------------------
p.DupSpacing=VCtl.EPI_ESP*14;
p.Duplicates=floor(VCtl.EPI_ETL/6);
p.Ext=5;
p.Notes=[];
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=CV3+CV10+CV11*2+CV14+1.664e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tStart=CV3+VCtl.TE+VCtl.ResPhase/2*VCtl.EPI_ESP;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=CV3+CV10+CV11*2+CV14+1.664e-3+CV6;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=CV3+CV10+CV11*2+CV14+1.664e-3+CV6*2;
if strcmp(p.Switch,'on')
...
p.tStart=CV3-2e-3;
if strcmp(p.Switch,'on')
[Ext7,ExtTime7]=ExtBit(p);
Ext=[Ext Ext7];
ExtTime=[ExtTime ExtTime7];
end
p=[];
%--------------------
p.DupSpacing=CV6;
...
p.tStart=CV3+CV10+CV11*2+CV14-2e-3;
if strcmp(p.Switch,'on')
[Ext8,ExtTime8]=ExtBit(p);
Ext=[Ext Ext8];
ExtTime=[ExtTime ExtTime8];
end
p=[];
%--------------------
p.DupSpacing=15e-3;
...
p.tStart=13e-3;
if strcmp(p.Switch,'on')
[Ext9,ExtTime9]=ExtBit(p);
Ext=[Ext Ext9];
ExtTime=[ExtTime ExtTime9];
end
p=[];
%--------------------
p.DupSpacing=0;
...
p.tStart=81e-3;
if strcmp(p.Switch,'on')
[Ext10,ExtTime10]=ExtBit(p);
Ext=[Ext Ext10];
ExtTime=[ExtTime ExtTime10];
end
p=[];
%--------------------
SEt=[tS tE];
