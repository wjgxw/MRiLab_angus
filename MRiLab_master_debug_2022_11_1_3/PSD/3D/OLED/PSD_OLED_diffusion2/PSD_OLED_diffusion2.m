...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED_diffusion2
global VCtl
global VVar
CV1=75e-3;
CV10=0;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=1/3*VCtl.EPI_ESP*VCtl.EPI_ETL+CV3+1e-3;
p.tStart=1/3*VCtl.EPI_ESP*VCtl.EPI_ETL+CV3-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=2/3*VCtl.EPI_ESP*VCtl.EPI_ETL+0.8e-3+CV3+2.016e-3;
p.tStart=2/3*VCtl.EPI_ESP*VCtl.EPI_ETL-0.8e-3+CV3+2.016e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=5/3*VCtl.EPI_ESP*VCtl.EPI_ETL+0.8e-3+CV3+2.016e-3*2+1.816e-3;
p.tStart=5/3*VCtl.EPI_ESP*VCtl.EPI_ETL-0.8e-3+CV3+2.016e-3*2+1.816e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p=[];
%--------------------
p.Area=4*1/VCtl.RFreq;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tEnd=VCtl.TE/2+VCtl.delta_TE/4-2e-3;
p.tStart=VCtl.TE/2+VCtl.delta_TE/4-3e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tEnd=VCtl.TE/2+VCtl.delta_TE/4+3e-3;
p.tStart=VCtl.TE/2+VCtl.delta_TE/4+2e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tEnd=VCtl.TE/2+VCtl.delta_TE/4-1.5e-3+77.14e-3;
p.tStart=VCtl.TE/2+VCtl.delta_TE/4-2.5e-3+77.14e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tEnd=VCtl.TE/2+VCtl.delta_TE/4+2.5e-3+77.14e-3;
p.tStart=VCtl.TE/2+VCtl.delta_TE/4+1.5e-3+77.14e-3;
if strcmp(p.Switch,'on')
[GzAmp5,GzTime5]=GzAreaTrapezoid(p);
GzAmp=[GzAmp GzAmp5];
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=7/6*VCtl.EPI_ESP*VCtl.EPI_ETL+2*2.016e-3;
if strcmp(p.Switch,'on')
[GyAmp1,GyTime1]=GyEPI_nodephase(p);
GyAmp=[GyAmp GyAmp1];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=2/3*VCtl.EPI_ESP*VCtl.EPI_ETL-1e-3+CV3+2.016e-3;
p.tStart=2/3*VCtl.EPI_ESP*VCtl.EPI_ETL-1.8e-3+CV3+2.016e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=2/3*VCtl.EPI_ESP*VCtl.EPI_ETL+1.8e-3+CV3+2.016e-3;
p.tStart=2/3*VCtl.EPI_ESP*VCtl.EPI_ETL+1e-3+CV3+2.016e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=5/3*VCtl.EPI_ESP*VCtl.EPI_ETL-1e-3+CV3+2.016e-3*2+1.816e-3;
p.tStart=5/3*VCtl.EPI_ESP*VCtl.EPI_ETL-1.5e-3+CV3+2.016e-3*2+1.816e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=5/3*VCtl.EPI_ESP*VCtl.EPI_ETL+1.5e-3+CV3+2.016e-3*2+1.816e-3;
p.tStart=5/3*VCtl.EPI_ESP*VCtl.EPI_ETL+1e-3+CV3+2.016e-3*2+1.816e-3;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=13/6*VCtl.EPI_ESP*VCtl.EPI_ETL+2*2.016e-3+3.632e-3;
if strcmp(p.Switch,'on')
[GyAmp6,GyTime6]=GyEPI_nodephase(p);
GyAmp=[GyAmp GyAmp6];
...
p.Switch=AttributeOpt{1};
p.grady_idx=1;
p.tStart=1/6*VCtl.EPI_ESP*VCtl.EPI_ETL;
if strcmp(p.Switch,'on')
[GyAmp7,GyTime7]=GyAreaTrapezoid2_ran(p);
GyAmp=[GyAmp GyAmp7];
...
p.Switch=AttributeOpt{1};
p.grady_idx=2;
p.tStart=3/6*VCtl.EPI_ESP*VCtl.EPI_ETL;
if strcmp(p.Switch,'on')
[GyAmp8,GyTime8]=GyAreaTrapezoid2_ran(p);
GyAmp=[GyAmp GyAmp8];
...
p.t2Middle=7/6*VCtl.EPI_ESP*VCtl.EPI_ETL+2*2.016e-3;
if strcmp(p.Switch,'on')
[GxAmp1,GxTime1]=GxEPI_nodephase(p);
GxAmp=[GxAmp GxAmp1];
GxTime=[GxTime GxTime1];
end
p=[];
%--------------------
p.Area=1.33*1/VCtl.RFreq;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
...
p.tStart=1/6*VCtl.EPI_ESP*VCtl.EPI_ETL;
if strcmp(p.Switch,'on')
[GxAmp7,GxTime7]=GxAreaTrapezoid2_ran(p);
GxAmp=[GxAmp GxAmp7];
...
p.tStart=3/6*VCtl.EPI_ESP*VCtl.EPI_ETL;
if strcmp(p.Switch,'on')
[GxAmp8,GxTime8]=GxAreaTrapezoid2_ran(p);
GxAmp=[GxAmp GxAmp8];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=7/6*VCtl.EPI_ESP*VCtl.EPI_ETL+2*2.016e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=13/6*VCtl.EPI_ESP*VCtl.EPI_ETL+2*2.016e-3+3.632e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=1/6*VCtl.EPI_ESP*VCtl.EPI_ETL+1e-3;
if strcmp(p.Switch,'on')
