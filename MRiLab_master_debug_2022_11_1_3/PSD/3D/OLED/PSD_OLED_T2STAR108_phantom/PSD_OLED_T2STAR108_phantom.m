...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED_T2STAR108_phantom
global VCtl
global VVar
CV1=1;
CV10=17.35e-3;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+CV10+CV11*2+CV14+1.664e-3;
...
p=[];
%--------------------
p.Area=-30/128*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
...
p=[];
%--------------------
p.Area=-17/128*VCtl.ResPhase/VCtl.EPI_ETL/VCtl.EPI_ShotNum/VCtl.RPhase;
p.DupSpacing=0;
p.Duplicates=1;
p.Notes=[];
AttributeOpt={'on','off'};
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{2};
p.tEnd=CV3+VCtl.TE+VCtl.ResPhase/2*VCtl.EPI_ESP+0.7e-3;
p.tStart=CV3+VCtl.TE+VCtl.ResPhase/2*VCtl.EPI_ESP+0.2e-3;
if strcmp(p.Switch,'on')
