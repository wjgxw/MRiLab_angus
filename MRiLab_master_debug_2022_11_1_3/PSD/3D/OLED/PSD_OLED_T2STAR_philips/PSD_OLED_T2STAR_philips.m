...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED_T2STAR_philips
global VCtl
global VVar
CV1=1;
CV10=(63.0/4)*VCtl.EPI_ESP*2;
CV11=(63.0/4)*VCtl.EPI_ESP*2;
CV12=3.54e-3;
CV13=31.22e-3;
CV14=12.25e-3;
CV2=80e-3;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+1e-3+CV10+CV11*3;
p.tStart=CV3-1e-3+CV10+CV11*3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV3+CV10+CV11*3+CV14+1e-3;
p.tStart=CV3+CV10+CV11*3+CV14-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
