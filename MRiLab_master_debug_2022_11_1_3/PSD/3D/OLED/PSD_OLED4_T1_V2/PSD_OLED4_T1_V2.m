...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED4_T1_V2
global VCtl
global VVar
CV1=75e-3;
CV10=0;
...
CV6=0;
CV7=2000e-3;
CV8=7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+1000e-3;
WJG_ran_rf=0;
rfAmpAll=[];
rfPhaseAll=[];
rfFreqAll=[];
...
p.CoilID=1;
p.DupSpacing=7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7;
p.Duplicates=2;
p.FA=VCtl.FlipAng;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4-2e-3+0.3e-3;
p.tStart=CV4-2e-3-0.3e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+7*VCtl.delta_TE+0.8e-3+2e-3;
p.tStart=CV4+7*VCtl.delta_TE-0.8e-3+2e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
p.tStart=CV4-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+VCtl.delta_TE*2+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
p.tStart=CV4+VCtl.delta_TE*2-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+4*VCtl.delta_TE+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
p.tStart=CV4+4*VCtl.delta_TE-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+6*VCtl.delta_TE+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
p.tStart=CV4+6*VCtl.delta_TE-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+7*VCtl.delta_TE+0.8e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8+2e-3;
p.tStart=CV4+7*VCtl.delta_TE-0.8e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8+2e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
[rfAmp11,rfPhase11,rfFreq11,rfCoil11,rfTime11]=rfSinc(p);
if strcmp(VCtl.MultiTransmit,'off')
if VCtl.MasterTxCoil==rfCoil11(1)
rfAmp=[rfAmp rfAmp11];
rfPhase=[rfPhase rfPhase11];
rfFreq=[rfFreq rfFreq11];
rfCoil=[rfCoil rfCoil11];
rfTime=[rfTime rfTime11];
end
else
rfAmp=[rfAmp rfAmp11];
rfPhase=[rfPhase rfPhase11];
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+7*VCtl.delta_TE-0.9e-3+2e-3;
p.tStart=CV4+7*VCtl.delta_TE-1.3e-3+2e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+7*VCtl.delta_TE+1.3e-3+2e-3;
p.tStart=CV4+7*VCtl.delta_TE+0.9e-3+2e-3;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=VCtl.TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1);
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{2};
p.t1Start=VCtl.TR;
p.t2Middle=VCtl.TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=1;
p.tStart=VCtl.CV4+VCtl.delta_TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=2;
p.tStart=VCtl.CV4+VCtl.delta_TE*3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=3;
p.tStart=VCtl.CV4+VCtl.delta_TE*5+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=4;
p.tStart=VCtl.CV4+VCtl.delta_TE*13/2+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+7*VCtl.delta_TE-0.9e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8+2e-3;
p.tStart=CV4+7*VCtl.delta_TE-1.3e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8+2e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+7*VCtl.delta_TE+1.3e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8+2e-3;
p.tStart=CV4+7*VCtl.delta_TE+0.9e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8+2e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.t1Start=CV4+7*VCtl.delta_TE+0.8e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8+2.7e-3;
p.t2Middle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{2};
p.t1Start=VCtl.TR;
p.t2Middle=VCtl.TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=VCtl.TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1);
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=CV4+7*VCtl.delta_TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=CV4+7*VCtl.delta_TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL+1)*2+1.6e-3+CV7+CV8;
if strcmp(p.Switch,'on')
