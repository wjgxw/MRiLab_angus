...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED4
global VCtl
global VVar
CV1=75e-3;
CV10=0;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+VCtl.delta_TE+1e-3;
p.tStart=CV4+VCtl.delta_TE-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+3*VCtl.delta_TE+1e-3;
p.tStart=CV4+3*VCtl.delta_TE-1e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+VCtl.TE/2+VCtl.delta_TE+0.8e-3;
p.tStart=CV4+VCtl.TE/2+VCtl.delta_TE-0.8e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.t1Start=CV4+VCtl.TE/2+VCtl.delta_TE-4e-3;
p.t2Middle=VCtl.TE;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+VCtl.TE/2+VCtl.delta_TE-1.9e-3;
p.tStart=CV4+VCtl.TE/2+VCtl.delta_TE-2.1e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+VCtl.TE/2+VCtl.delta_TE+1.2e-3;
p.tStart=CV4+VCtl.TE/2+VCtl.delta_TE+1e-3;
if strcmp(p.Switch,'on')
