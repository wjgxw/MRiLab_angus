...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLEDM
global VCtl
global VVar
CV1=75e-3;
CV10=0;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.delta_TE*2+0.5e-3;
p.tStart=VCtl.delta_TE*2-0.5e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.delta_TE*3+0.5e-3;
p.tStart=VCtl.delta_TE*3-0.5e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.delta_TE*4+0.5e-3;
p.tStart=VCtl.delta_TE*4-0.5e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.delta_TE*5+0.5e-3;
p.tStart=VCtl.delta_TE*5-0.5e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
