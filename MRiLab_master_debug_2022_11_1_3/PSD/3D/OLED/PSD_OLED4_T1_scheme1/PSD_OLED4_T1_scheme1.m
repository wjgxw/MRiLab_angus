...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_OLED4_T1_scheme1
global VCtl
global VVar
CV1=75e-3;
CV10=0;
...
CV6=0;
CV7=1000e-3;
CV8=7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+1.6e-3+1000e-3;
WJG_ran_rf=0;
rfAmpAll=[];
rfPhaseAll=[];
rfFreqAll=[];
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
p.tStart=CV4-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+VCtl.delta_TE*2+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
p.tStart=CV4+VCtl.delta_TE*2-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+4*VCtl.delta_TE+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
p.tStart=CV4+4*VCtl.delta_TE-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+6*VCtl.delta_TE+1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
p.tStart=CV4+6*VCtl.delta_TE-1e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=CV4+7*VCtl.delta_TE+0.8e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8+2e-3;
p.tStart=CV4+7*VCtl.delta_TE-0.8e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8+2e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TR;
p.t2Middle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=1;
p.tStart=VCtl.CV4+VCtl.delta_TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=2;
p.tStart=VCtl.CV4+VCtl.delta_TE*3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=3;
p.tStart=VCtl.CV4+VCtl.delta_TE*5+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
...
p.Switch=AttributeOpt{1};
p.grady_idx=4;
p.tStart=VCtl.CV4+VCtl.delta_TE*13/2+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+7*VCtl.delta_TE-0.9e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8+2e-3;
p.tStart=CV4+7*VCtl.delta_TE-1.3e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8+2e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tEnd=CV4+7*VCtl.delta_TE+1.3e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8+2e-3;
p.tStart=CV4+7*VCtl.delta_TE+0.9e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8+2e-3;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.t1Start=CV4+7*VCtl.delta_TE+0.8e-3+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8+2.7e-3;
p.t2Middle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7;
if strcmp(p.Switch,'on')
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tMiddle=VCtl.TE+7*VCtl.delta_TE+VCtl.EPI_ESP*(VCtl.EPI_ETL)*2+CV12*2+CV7+CV8;
if strcmp(p.Switch,'on')
