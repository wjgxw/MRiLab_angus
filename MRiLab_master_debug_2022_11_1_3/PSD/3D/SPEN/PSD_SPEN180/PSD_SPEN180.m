...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_SPEN180
global VCtl
global VVar
...
p.rfFile='rfUserSinc';
p.rfPhase=0;
p.tEnd=VCtl.TE- VCtl.Tacq/1.5;
p.tStart=VCtl.TE- VCtl.Tacq/1.5-VCtl.Texc;
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TE- VCtl.Tacq/1.5-VCtl.Texc;
p.t2Middle=VCtl.TE;
if strcmp(p.Switch,'on')
[GyAmp1,GyTime1]=Gychirp(p);
GyAmp=[GyAmp GyAmp1];
...
p=[];
%--------------------
p.DupSpacing=VCtl.Tacq/40;
p.Duplicates=40;
p.Ext=5;
p.Notes=[];
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.tStart=VCtl.TE-VCtl.Tacq/2;
if strcmp(p.Switch,'on')
