...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_SPEN
global VCtl
global VVar
CV1=20e-3;
CV10=0;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.TE/2+0.8e-3;
p.tStart=VCtl.TE/2-0.8e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.t1Start=VCtl.TE-VCtl.Tacq/2-5e-3;
p.t2Middle=VCtl.TE;
if strcmp(p.Switch,'on')
