...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_GINSENG
global VCtl
global VVar
CV1=2e-3;
CV10=0;
...
AttributeOpt={'on','off'};
p.Switch=AttributeOpt{1};
p.t1End=VCtl.TE/2+CV2;
p.t1Start=VCtl.TE/2+CV1;
p.t2End=VCtl.TE+CV2;
p.t2Start=VCtl.TE+CV1;
p.tRamp=100e-6;
if strcmp(p.Switch,'on')
