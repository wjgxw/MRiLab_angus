...
% MRiLab Version 1.3                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [rfAmp,rfPhase,rfFreq,rfCoil,GzAmp,GyAmp,GxAmp,ADC,Ext,uts,ts,flags]=PSD_GINSEST
global VCtl
global VVar
CV1=2e-3;
CV10=0;
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.TE/2+0.5e-3;
p.tStart=VCtl.TE/2-0.5e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.rfFreq=0;
p.rfPhase=0;
p.tEnd=VCtl.TE+0.5e-3;
p.tStart=VCtl.TE-0.5e-3;
if strcmp(p.Switch,'on')
if strcmp(p.AnchorTE,'on')
switch VCtl.TEAnchor
case 'Start'
...
p.Switch=AttributeOpt{1};
p.t1Start=CV1;
p.t2Middle=VCtl.TE*3/2;
p.t3Start=VCtl.TE/2+CV1;
p.tRamp=100e-6;
if strcmp(p.Switch,'on')
