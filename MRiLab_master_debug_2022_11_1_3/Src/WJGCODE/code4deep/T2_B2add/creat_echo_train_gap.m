function [rand_map,rand_small_map]=creat_echo_train_gap(expand_num)
...
rand_max_value=0.8*rand()+0.5;
rand_min_value=0.8*rand()+0.4;
% 
% if rand()>0.5
...
rand_small_map=0.94+0.04*(rand_small_map-min_value)/(max_value-min_value);
