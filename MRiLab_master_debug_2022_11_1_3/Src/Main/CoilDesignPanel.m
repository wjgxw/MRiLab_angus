...
if (ndims(Mxdims)==2)||(Mxdims(3) ==1)
    Mxdims(3) = 1;
    mxgrid = linspace((-(Mxdims(2))/2)*VObj.XDimRes,((Mxdims(2))/2)*VObj.XDimRes,Mxdims(2));
    mygrid = linspace((-(Mxdims(1))/2)*VObj.XDimRes,((Mxdims(1))/2)*VObj.XDimRes,Mxdims(1));
    mzgrid = 1e-10;
